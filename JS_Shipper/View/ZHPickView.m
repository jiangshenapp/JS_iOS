...
- (void)setDateViewWithTitle:(NSString *)title
{
    isDate = YES;
    proTitleList = @[];
    UIView *header = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREENSIZE.width, 49.5)];
    header.backgroundColor = [UIColor whiteColor];
    
    UILabel *titleLbl = [[UILabel alloc] initWithFrame:CGRectMake(40, 0, SCREENSIZE.width - 80, 49.5)];
    titleLbl.text = title;
    ...
    UIButton *submit = [[UIButton alloc] initWithFrame:CGRectMake(SCREENSIZE.width - 80, 10, 70 ,29.5)];
    ...
    submit.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    [submit addTarget:self action:@selector(submit:) forControlEvents:UIControlEventTouchUpInside];
    [header addSubview:submit];
    
    UIButton *cancel = [[UIButton alloc] initWithFrame:CGRectMake(10, 10, 70 ,29.5)];
...
- (void)setDataViewWithItem:(NSArray *)items title:(NSString *)title
{
    ...
    [self addSubview:header];
    UIPickerView *pick = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 50, SCREENSIZE.width, 260)];
...
{
    ((UIView *)[pickerView.subviews objectAtIndex:1]).backgroundColor = RGBValue(0xf5f5f5);
    ((UIView *)[pickerView.subviews objectAtIndex:2]).backgroundColor = RGBValue(0xf5f5f5);
