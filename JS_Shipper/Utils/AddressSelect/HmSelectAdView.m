...
- (void)setupView {
    ...
    [self addSubview:vv];
    // title
    UILabel *lblTitle = [[UILabel alloc] initWithFrame:CGRectMake(0, 10, vv.hm_width, kTitleHeight)];
    lblTitle.textColor = HmColorRGB(51, 51, 51);
...
- (void)HmGetArea {
    ...
    NSData *data = [NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"Area.txt" ofType:nil]];
    if (!data) {
        return;
    }
